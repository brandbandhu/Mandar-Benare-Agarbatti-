...
const faqs = [
  [
    "Which agarbatti is best for daily puja?",
    "Our Hrishikesh and Swami Masala Agarbatti, along with Chandan Black, are loved for daily worship.",
  ],
  [
  ...
  [
    "Do you offer dhoop and pooja samagri?",
    "Yes — explore our full Dhoop and Pooja Samagri categories for a complete ritual setup.",
  ],
  [
  ...
  [
    "How should agarbatti and dhoop be stored?",
