...
const map: Record<string, { name: "Agarbatti" | "Dhoop" | "Pooja Samagri"; copy: string }> = {
  agarbatti: {
    name: "Agarbatti",
    copy: "Explore premium agarbatti for daily prayer, meditation and home fragrance. Choose from Gulab, Kewda, Mogra, Chandan, Masala Agarbatti and premium devotional fragrances.",
  },
  dhoop: {
    name: "Dhoop",
    copy: "Bring depth, purity and divine aroma to your pooja rituals with dhoop sticks, cup dhoop, dhoop candy, loban, gugul and more.",
  },
  "pooja-samagri": {
    name: "Pooja Samagri",
    copy: "Complete your daily worship with essential pooja samagri including Ashtagandha, Chandan Tika, Pure Ghee Batti, Kapoor Dani and Camphor Cones.",
  },
};
...
export const Route = createFileRoute("/category/$slug")({
  ...
  head: ({ params }) => {
    ...
    return {
      meta: c
        ? [
            { title: `${c.name} — Mandar Benare Agarbatti` },
